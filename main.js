/*
Our Link: https://teachablemachine.withgoogle.com/models/qFQXrV53K/
*/
...
classifier=ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/qFQXrV53K/model.json', modelLoaded);
...
function gotResult(error, results){
    if(error){
        ...
        if(results[1].label=="Happy"){
            document.getElementById("update_emoji_2").innerHTML="&#128514";
        }
        if(results[1].label=="Sad"){
            document.getElementById("update_emoji_2").innerHTML="&#128542";
        }
